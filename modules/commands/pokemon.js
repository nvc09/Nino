...
module.exports.run = async ({ api, event, args, Users }) => {
    ...
    switch (args[0]) {
        ...
        case '-f': {
            ...
            writeFileSync( __dirname + "/Trò_chơi/pokemon/cache/pokemonfind.png", Buffer.from(pokemon, "utf-8") );
            image.push(createReadStream(__dirname + "/Trò_chơi/pokemon/cache/pokemonfind.png"));
  ...
  var path1 = __dirname + "/Trò_chơi/cache/pokemon.jpg"
    ...
    switch (handleReply.type) {
        ...
        case 'playerSolo': {
            ...
            gameThread.player.push({ name: q.name, userID: senderID, choose: { status: true, msg: { name: pet.name ,type: pet.type, HP: pet.HP, Attack: pet.Attack, Defense: pet.Defense, Speed: pet.Speed, skill: pet.skill, images: pet.images } } });
                ...
                writeFileSync( __dirname + `/Trò_chơi/pokemon/cache/${gameThread.number}.png`, Buffer.from(pokemon, "utf-8") );
                image.push(createReadStream(__dirname + `/Trò_chơi/pokemon/cache/${gameThread.number}.png`));
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout( async function () {
                            ...
                            if(!existsSync(__dirname+'/Trò_chơi/pokemon/cache/Bangers-Regular.ttf')) { 
