...
module.exports.run = async function({ api, args, event, Users,handleReply,permssion }) {
  ...
  const picture = (await axios.get(`https://i.imgur.com/M0WZEEU.mp4`, { responseType: "stream"})).data
...
${Date.now() - ping}ms.\n\n`}`
    ...
    var callback = () =>
      api.sendMessage({
        body: `ㅤㅤ🌸 𝐀𝐃𝐌𝐈𝐍 𝐁𝐎𝐓 🌸\n
👀 𝐓𝐞̂𝐧: 𝓝𝓰 𝓥𝓪̆𝓷 𝓒𝓱𝓲𝓮̂́𝓷
❎ 𝐓𝐮𝐨̂̉𝐢: 14
👤 𝐆𝐢𝐨̛́𝐢 𝐓𝐢́𝐧𝐡: 𝗡𝗮𝗺
💫 𝐂𝐡𝐢𝐞̂̀𝐮 𝐜𝐚𝐨 𝐜𝐚̂𝐧 𝐧𝐚̣̆𝐧𝐠: 𝟏𝒎𝟕𝟓 𝒙 𝟓𝟓𝒌𝒈
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: 𝑫𝒐𝒂́𝒏 𝒙𝒆𝒎
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧:
👫 𝐆𝐮: 𝗕𝗶𝗲̂́𝘁 𝒙𝒊𝒏𝒉 𝒈𝒂́𝒊 , 𝒕𝒐̂́𝒕 𝒕𝒊́𝒏𝒉 
🌸 𝐓𝐢́𝐧𝐡 𝐜𝐚́𝐜𝐡: 𝑩𝒐𝒚 𝒍𝒂̣𝒏𝒉 𝒍𝒖̀𝒏𝒈 =)) 
🌀 𝐒𝐨̛̉ 𝐭𝐡𝐢́𝐜𝐡: 𝗖𝗵𝗼̛𝗶 𝗴𝗮𝗺𝗲, 𝘅𝗲𝗺 𝗽𝗵𝗶𝗺 𝗯𝗹𝗮𝗯𝗹𝗮, 𝗮̆𝗻, 𝗻𝗴𝘂̉
💻 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: 
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤:𝐡𝐭𝐭𝐩𝐬://𝐰𝐰𝐰.𝐟𝐚𝐜𝐞𝐛𝐨𝐨𝐤.𝐜𝐨𝐦/vanchiendzs`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100048286966787}/picture?height=720&width=720&access_token=1073911769817594|aa417da57f9e260d1ac1ec4530b417de`)).pipe(
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100048286966787) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
